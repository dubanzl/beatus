...
--
-- Host: localhost
-- Generation Time: Jul 30, 2017 at 09:19 AM
...
--
-- Table structure for table `bt_access`
--

CREATE TABLE `bt_access` (
  `acc_token` varchar(250) NOT NULL,
  `user_id` varchar(250) DEFAULT NULL,
  `acc_faile_att` int(11) DEFAULT NULL,
...
--
-- Table structure for table `bt_approval`
--

CREATE TABLE `bt_approval` (
...
--
-- Dumping data for table `bt_approval`
--

INSERT INTO `bt_approval` (`app_id`, `app_name`, `app_description`, `app_status`, `app_author`, `app_date`) VALUES
(1, 'eliminar', 'puede eliminar contenido ', 'activo ', 'admin ', '2017-06-12'),
(2, 'guardar', 'puder guardar archivos', 'activo', 'admin', '2016-06-02'),
(3, 'modificar', 'puede modificar datos', 'activo ', 'admin ', '2016-03-05');

-- --------------------------------------------------------

--
-- Table structure for table `bt_approval_rol`
--

CREATE TABLE `bt_approval_rol` (
  `app_id` int(11) NOT NULL,
  `rol_id` int(11) NOT NULL,
  `ar_name` varchar(60) NOT NULL,
  `ar_description` varchar(100) DEFAULT NULL,
  `ar_status` varchar(100) NOT NULL,
  `ar_author` varchar(50) NOT NULL,
...
--
-- Table structure for table `bt_category_church`
--

CREATE TABLE `bt_category_church` (
  `cat_id` int(11) NOT NULL,
  `cat_name` varchar(100) NOT NULL,
  `cat_description` mediumtext,
  `cat_date` date DEFAULT NULL,
  `cat_author` varchar(60) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `bt_church`
--

CREATE TABLE `bt_church` (
  `chu_id` int(11) NOT NULL,
  `chu_name` varchar(120) NOT NULL,
  `chu_photo` mediumtext,
  `chu_phone` varchar(120) DEFAULT NULL,
  `chu_address` varchar(200) NOT NULL,
  `chu_email` varchar(100) DEFAULT NULL,
  `chu_description` mediumtext,
  `chu_legal_representative` varchar(60) NOT NULL,
...
--
-- Dumping data for table `bt_city`
--

INSERT INTO `bt_city` (`city_id`, `city_name`, `sta_id`) VALUES
(1, 'Bombuflat', 1),
(2, 'Garacharma', 1),
(3, 'Port Blair', 1),
(4, 'Rangat', 1),
...
--
-- Table structure for table `bt_country`
--

CREATE TABLE `bt_country` (
  `cou_id` int(11) NOT NULL,
  `cou_sortname` varchar(3) NOT NULL,
  `cou_name` varchar(150) NOT NULL,
  `cou_phonecode` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `bt_country`
--

INSERT INTO `bt_country` (`cou_id`, `cou_sortname`, `cou_name`, `cou_phonecode`) VALUES
(1, 'AF', 'Afghanistan', 93),
(2, 'AL', 'Albania', 355),
(3, 'DZ', 'Algeria', 213),
...
--
-- Table structure for table `bt_follower`
--

CREATE TABLE `bt_follower` (
  `fol_id` int(11) NOT NULL,
  `fol_name` varchar(100) NOT NULL,
  `fol_email` varchar(100) NOT NULL,
  `fol_phone` varchar(100) DEFAULT NULL,
  `fol_date` date DEFAULT NULL,
...
CREATE TABLE `bt_message` (
  ...
  `mes_title` varchar(30) NOT NULL,
  `mes_decription` mediumtext NOT NULL,
...
--
-- Table structure for table `bt_publication`
--

CREATE TABLE `bt_publication` (
  `pub_id` int(11) NOT NULL,
  `pub_title` varchar(40) NOT NULL,
  `pub_description` mediumtext NOT NULL,
...
--
-- Table structure for table `bt_rol`
--
...
CREATE TABLE `bt_rol` (
  ...
  `rol_author` varchar(50) NOT NULL,
  `rol_date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `bt_rol`
--

INSERT INTO `bt_rol` (`rol_id`, `rol_name`, `rol_description`, `rol_status`, `rol_author`, `rol_date`) VALUES
(1, 'admin', 'admnistrador de la aplicacion web', 'activo ', 'admin ', '2017-07-12'),
(2, 'entidad', 'administrador de iglesias', 'activo', 'admin ', '2017-07-12');

-- --------------------------------------------------------

--
-- Table structure for table `bt_schedules`
--

CREATE TABLE `bt_schedules` (
  `sch_id` int(11) NOT NULL,
  `sch_title` varchar(40) NOT NULL,
  `sch_description` mediumtext NOT NULL,
...
--
-- Table structure for table `bt_state`
--

CREATE TABLE `bt_state` (
...
--
-- Dumping data for table `bt_state`
--

INSERT INTO `bt_state` (`sta_id`, `sta_name`, `cou_id`) VALUES
...
--
-- Table structure for table `bt_type_publication`
--

CREATE TABLE `bt_type_publication` (
  `tp_id` int(11) NOT NULL,
  `tp_title` varchar(40) NOT NULL,
  `tp_description` mediumtext,
  `tp_author` varchar(60) NOT NULL,
...
CREATE TABLE `bt_user` (
  ...
  `user_phone` varchar(300) DEFAULT NULL,
...
--
-- Indexes for table `bt_access`
--
ALTER TABLE `bt_access`
  ADD PRIMARY KEY (`acc_token`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `bt_approval`
--
ALTER TABLE `bt_approval`
  ADD PRIMARY KEY (`app_id`);

--
-- Indexes for table `bt_approval_rol`
--
ALTER TABLE `bt_approval_rol`
  ADD PRIMARY KEY (`app_id`,`rol_id`),
  ADD KEY `rol_id` (`rol_id`);

--
-- Indexes for table `bt_category_church`
--
ALTER TABLE `bt_category_church`
  ADD PRIMARY KEY (`cat_id`);

--
-- Indexes for table `bt_church`
--
ALTER TABLE `bt_church`
...
--
-- Indexes for table `bt_country`
--
ALTER TABLE `bt_country`
  ADD PRIMARY KEY (`cou_id`);

--
-- Indexes for table `bt_follower`
--
...
--
-- Indexes for table `bt_publication`
--
ALTER TABLE `bt_publication`
  ADD PRIMARY KEY (`pub_id`),
  ADD KEY `church_id` (`church_id`),
  ADD KEY `tp_id` (`tp_id`);

--
-- Indexes for table `bt_rol`
--
ALTER TABLE `bt_rol`
  ADD PRIMARY KEY (`rol_id`);

--
-- Indexes for table `bt_schedules`
--
ALTER TABLE `bt_schedules`
  ADD PRIMARY KEY (`sch_id`),
  ADD KEY `church_id` (`church_id`);

--
-- Indexes for table `bt_state`
--
ALTER TABLE `bt_state`
  ADD PRIMARY KEY (`sta_id`),
  ADD KEY `cou_id` (`cou_id`);

--
-- Indexes for table `bt_type_publication`
--
ALTER TABLE `bt_type_publication`
  ADD PRIMARY KEY (`tp_id`);

--
-- Indexes for table `bt_user`
--
ALTER TABLE `bt_user`
...
--
-- AUTO_INCREMENT for table `bt_approval`
--
ALTER TABLE `bt_approval`
  MODIFY `app_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `bt_category_church`
--
ALTER TABLE `bt_category_church`
  MODIFY `cat_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bt_church`
--
ALTER TABLE `bt_church`
...
--
-- AUTO_INCREMENT for table `bt_country`
--
ALTER TABLE `bt_country`
  MODIFY `cou_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=247;
--
-- AUTO_INCREMENT for table `bt_follower`
--
ALTER TABLE `bt_follower`
  MODIFY `fol_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bt_message`
--
ALTER TABLE `bt_message`
  MODIFY `mes_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bt_publication`
--
ALTER TABLE `bt_publication`
  MODIFY `pub_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bt_rol`
--
ALTER TABLE `bt_rol`
  MODIFY `rol_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `bt_schedules`
--
ALTER TABLE `bt_schedules`
  MODIFY `sch_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bt_state`
--
ALTER TABLE `bt_state`
  MODIFY `sta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2181;
--
-- AUTO_INCREMENT for table `bt_type_publication`
--
ALTER TABLE `bt_type_publication`
...
--
-- Constraints for table `bt_access`
--
ALTER TABLE `bt_access`
  ADD CONSTRAINT `bt_access_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `bt_user` (`user_id`) ON UPDATE CASCADE;

--
-- Constraints for table `bt_approval_rol`
--
ALTER TABLE `bt_approval_rol`
  ADD CONSTRAINT `bt_approval_rol_ibfk_1` FOREIGN KEY (`rol_id`) REFERENCES `bt_rol` (`rol_id`),
  ADD CONSTRAINT `bt_approval_rol_ibfk_2` FOREIGN KEY (`app_id`) REFERENCES `bt_approval` (`app_id`) ON UPDATE CASCADE;

--
-- Constraints for table `bt_church`
--
ALTER TABLE `bt_church`
  ADD CONSTRAINT `bt_church_ibfk_1` FOREIGN KEY (`city_id`) REFERENCES `bt_city` (`city_id`),
  ADD CONSTRAINT `bt_church_ibfk_2` FOREIGN KEY (`cat_id`) REFERENCES `bt_category_church` (`cat_id`),
  ADD CONSTRAINT `bt_church_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `bt_user` (`user_id`) ON UPDATE CASCADE;

--
-- Constraints for table `bt_city`
--
ALTER TABLE `bt_city`
  ADD CONSTRAINT `bt_city_ibfk_1` FOREIGN KEY (`sta_id`) REFERENCES `bt_state` (`sta_id`) ON UPDATE CASCADE;

--
-- Constraints for table `bt_follower`
--
ALTER TABLE `bt_follower`
  ADD CONSTRAINT `bt_follower_ibfk_1` FOREIGN KEY (`church_id`) REFERENCES `bt_church` (`chu_id`) ON UPDATE CASCADE;

--
-- Constraints for table `bt_message`
--
ALTER TABLE `bt_message`
  ADD CONSTRAINT `bt_message_ibfk_1` FOREIGN KEY (`church_id`) REFERENCES `bt_church` (`chu_id`) ON UPDATE CASCADE;

--
-- Constraints for table `bt_publication`
--
ALTER TABLE `bt_publication`
  ADD CONSTRAINT `bt_publication_ibfk_1` FOREIGN KEY (`church_id`) REFERENCES `bt_church` (`chu_id`),
  ADD CONSTRAINT `bt_publication_ibfk_2` FOREIGN KEY (`tp_id`) REFERENCES `bt_type_publication` (`tp_id`) ON UPDATE CASCADE;

--
-- Constraints for table `bt_schedules`
--
ALTER TABLE `bt_schedules`
  ADD CONSTRAINT `bt_schedules_ibfk_1` FOREIGN KEY (`church_id`) REFERENCES `bt_church` (`chu_id`) ON UPDATE CASCADE;

--
-- Constraints for table `bt_state`
--
ALTER TABLE `bt_state`
  ADD CONSTRAINT `bt_state_ibfk_1` FOREIGN KEY (`cou_id`) REFERENCES `bt_country` (`cou_id`) ON UPDATE CASCADE;

--
-- Constraints for table `bt_user`
--
ALTER TABLE `bt_user`
  ADD CONSTRAINT `bt_user_ibfk_1` FOREIGN KEY (`rol_id`) REFERENCES `bt_rol` (`rol_id`),
  ADD CONSTRAINT `bt_user_ibfk_2` FOREIGN KEY (`city_id`) REFERENCES `bt_city` (`city_id`) ON UPDATE CASCADE;
COMMIT;
